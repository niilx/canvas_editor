...
class CanvasImageEditorController {
  _CanvasEditorViewState? _editorViewState;

  void _init(_CanvasEditorViewState editorViewState) {
...
class CanvasEditorView extends StatefulWidget {
  const CanvasEditorView({
    ...
    this.removeIcon = const CircleAvatar(
  ...
  @override
  _CanvasEditorViewState createState() => _CanvasEditorViewState();

  final Function(CanvasImageEditorController) onInitialize;
...
class _CanvasEditorViewState extends State<CanvasEditorView> {
  ...
  void _addViewInList(Widget view, String? widgetType, {Matrix4? matrix4}) {
    ...
    final resizableView = ResizableWidget(
      ...
      onTouchOver: (key, position, matrix) {
        // Matrix4 matrix4 =
        // Matrix4(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15)
        var myTransform = Matrix4Transform.from(matrix);
        print("myTransform.m.toString()");
        print(myTransform.matrix4.toString());
        print("Rotation");
        print(myTransform.matrix4.getRotation().toString());
        print("Translation");
        print(myTransform.matrix4.getTranslation().toString());
        print("Scale");
        print(myTransform.matrix4.getMaxScaleOnAxis().toString());
        double scaleX = matrix.storage[0]; // Scale X
        double scaleY = matrix.storage[5]; // Scale Y
        double scaleZ = matrix.storage[10]; // Scale Z
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) {
      CanvasImageEditorController easyImageEditorController =
      CanvasImageEditorController();
